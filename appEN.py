...
def msDetectionCompare():
    ...
    abstract = "This application page that automatically detects MS plaques in MR images and compares \
                them with physician vision. For this, you must load the segmentation information of the MR images \
                in VGG 1.0.6 format. "
...
def msFollowUpCompare():
    ...
    abstract = "It is our application page that displays the MS plaques marked by the physicians and \
                compares the images taken in two different periods. \
                For this, you must upload your segmentation file in MR section and VGG 1.0.6 format."
